...
public abstract class ExtendedSocketOptions {
    ...
    // This represents the case: I can be set until I am read. If not set, there is a
    // default way to compute me.

    private static final ComputedConstant.OfDeferred<ExtendedSocketOptions> instance =
            ComputedConstant.ofDeferred();

    public static ExtendedSocketOptions getInstance() {
        return instance.orElseSet(
                new Supplier<ExtendedSocketOptions>() {
                    @Override
