 ...
 *     }
 *}
 * Lazy contain an additional method for getting any
 * {@linkplain java.util.concurrent.lazy.LazyValue#exception()} that might be thrown
 * by the provider.
 *
 ...
 *                 LazyValue.ofArray(64, EAGER_VALUE);
 *
 *         public static void main(String[] args) {
