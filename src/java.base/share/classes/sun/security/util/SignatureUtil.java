...
public class SignatureUtil {
    ...
    public static void initVerifyWithParam(Signature s, PublicKey key,
        ...
        SharedSecrets.getOrThrow(JavaSecuritySignatureAccess.class).initVerify(s, key, params);
    }
    ...
    public static void initVerifyWithParam(Signature s,
            ...
            AlgorithmParameterSpec params)
            throws InvalidAlgorithmParameterException, InvalidKeyException {
        SharedSecrets.getOrThrow(JavaSecuritySignatureAccess.class).initVerify(s, cert, params);
    }
    ...
    public static void initSignWithParam(Signature s, PrivateKey key,
            ...
            throws InvalidAlgorithmParameterException, InvalidKeyException {
        SharedSecrets.getOrThrow(JavaSecuritySignatureAccess.class).initSign(s, key, params, sr);
    }
