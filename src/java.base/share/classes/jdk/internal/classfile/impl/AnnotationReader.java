...
public final class AnnotationReader {
    ...
    public static List<Annotation> readAnnotations(ClassReader classReader, int p) {
        ...
        return SharedSecrets.getOrThrow(JavaUtilCollectionAccess.class).listFromTrustedArray(annos);
    }
    ...
    public static AnnotationValue readElementValue(ClassReader classReader, int p) {
        ...
        return switch (tag) {
            ...
            case TAG_ARRAY -> {
                ...
                yield new AnnotationImpl.OfArrayImpl(SharedSecrets.getOrThrow(JavaUtilCollectionAccess.class).listFromTrustedArray(values));
            }
    ...
    public static List<TypeAnnotation> readTypeAnnotations(ClassReader classReader, int p, LabelContext lc) {
        ...
        return SharedSecrets.getOrThrow(JavaUtilCollectionAccess.class).listFromTrustedArray(annotations);
    }
    ...
    public static List<List<Annotation>> readParameterAnnotations(ClassReader classReader, int p) {
        ...
        return SharedSecrets.getOrThrow(JavaUtilCollectionAccess.class).listFromTrustedArray(pas);
    }
    ...
    private static List<AnnotationElement> readAnnotationElementValuePairs(ClassReader classReader, int p) {
        ...
        return SharedSecrets.getOrThrow(JavaUtilCollectionAccess.class).listFromTrustedArray(annotationElements);
    }
    ...
    private static List<TypeAnnotation.LocalVarTargetInfo> readLocalVarEntries(ClassReader classReader, int p, LabelContext lc, int targetType) {
        ...
        return SharedSecrets.getOrThrow(JavaUtilCollectionAccess.class).listFromTrustedArray(entries);
    }
