...
public final class System {
    ...
    // private static final Supplier<Console> cons = StableValue.supplier(SharedSecrets.getJavaIOAccess()::console);
    private static final Supplier<Console> cons = StableValue.supplier(
