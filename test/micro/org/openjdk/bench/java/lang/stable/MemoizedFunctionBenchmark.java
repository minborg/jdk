...
public class MemoizedFunctionBenchmark {
    ...
    // Mutable
    private static final Map<Integer, Integer> VALUES = new ConcurrentHashMap<>(Map.of(0, VALUE, 1, VALUE2));

    private static final Function<Integer, Integer> F = VALUES::get;
    private final Function<Integer, Integer> f = VALUES::get;

    private final Function<Integer, Integer> m = StableArray.memoizedFunction(Set.of(0, 1), VALUES::get);
    private static final Function<Integer, Integer> M = StableArray.memoizedFunction(Set.of(0, 1), VALUES::get);;
