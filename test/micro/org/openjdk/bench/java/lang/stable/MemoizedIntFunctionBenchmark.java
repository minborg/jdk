...
public class MemoizedIntFunctionBenchmark {
    ...
    // Mutable
    private static final List<Integer> VALUES = new ArrayList<>(List.of(VALUE, VALUE2));

    private static final IntFunction<Integer> F = VALUES::get;
    private final IntFunction<Integer> f = VALUES::get;

    private final IntFunction<Integer> m = StableArray.memoizedIntFunction(2, VALUES::get);
    private static final IntFunction<Integer> M = StableArray.memoizedIntFunction(2, VALUES::get);;
